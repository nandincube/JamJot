 ...
 * This includes all data from the PlaylistTrackDTO as well as the track number in the playlist, which is relevant when retrieving tracks in the context of a playlist.
...
public record TrackDTO(
    ...
    @Schema(description = "Information about thetrack")
    PlaylistTrackDTO entry
) {}
