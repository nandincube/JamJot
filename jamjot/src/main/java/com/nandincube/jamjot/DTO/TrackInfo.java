 ...
 *
 * This DTO is meant to mirror the structure of the TrackObject found in the Spotify API response for retrieving tracks, which includes all relevant metadata about a track.
 * */
